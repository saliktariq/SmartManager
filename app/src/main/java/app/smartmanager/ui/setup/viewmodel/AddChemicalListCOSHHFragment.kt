 ...
 * Use the [AddChemicalListCOSHHFragment.newInstance] factory method to
...
class AddChemicalListCOSHHFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddChemicalListCOSHHFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddChemicalListCOSHHFragment().apply {
