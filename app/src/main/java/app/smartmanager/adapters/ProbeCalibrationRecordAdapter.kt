...
class ProbeCalibrationRecordAdapter: RecyclerView.Adapter<ProbeCalibrationRecordAdapter.MyViewHolder>() {
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val probeCalibrationRecordSingleRecord = itemView.findViewById<LinearLayout>(R.id.probeCalibrationRecordSingleRecord)
...
//                itemView.findNavController().navigate(action)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProbeCalibrationRecordAdapter.MyViewHolder {

        //Returning ProbeCalibrationRecord list item view
        return MyViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.probe_calibration_record_list_item, parent, false))
    }

    override fun onBindViewHolder(holder: ProbeCalibrationRecordAdapter.MyViewHolder, position: Int) {
